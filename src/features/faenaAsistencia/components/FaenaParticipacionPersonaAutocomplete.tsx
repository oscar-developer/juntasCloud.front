...
import { getPersonaOptionLabel } from './faenaParticipacionUi';

type FaenaParticipacionPersonaAutocompleteProps = {
  tenantId: string;
...
export function FaenaParticipacionPersonaAutocomplete({
  tenantId,
  initialOptions = [],
  label,
  value,
  ...
  helperText,
  onBlur,
}: FaenaParticipacionPersonaAutocompleteProps) {
  ...
  const noOptionsText = useMemo(() => {
    ...
    return 'No hay personas activas disponibles';
